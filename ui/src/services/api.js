...
//   getTradingSignals: () => api.get('/api/trading-signals'),
//   getStockForecasts: (symbol = null) => {
//     const params = symbol ? { symbol } : {};
//     return api.get('/api/stock-forecasts', { params });
//   },
//   getForecastSummary: () => api.get('/api/forecast-summary'),
...
export const dashboardService = {
  ...
  // NEW ENDPOINTS FOR TIME SERIES DATA
  getTradingSignals: () => api.get('/api/trading-signals'),
  getStockForecasts: (symbol = null) => {
    const params = symbol ? { symbol } : {};
    return api.get('/api/stock-forecasts', { params });
