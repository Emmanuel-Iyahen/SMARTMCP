...
# async def test_snowflake_connection(request: Request):
#     try:
...
#         logger.info("🔍 Testing Snowflake connection with:")
...
#             return {
#                 "success": False,
#                 "message": "❌ Missing one or more required Snowflake env vars",
#                 "details": {
#                     "SNOWFLAKE_USER": user,
#                     "SNOWFLAKE_PASSWORD": "✅" if password else "❌",
...
#         return {
#             "success": True,
#             "message": f"✅ Connected to Snowflake. Version: {version[0]}",
#             "used_credentials": {
#                 "user": user,
#                 "account": account,
#                 "warehouse": warehouse,
...
#     except Exception as e:
#         logger.error(f"❌ Exception during Snowflake connection test: {e}")
#         return {
#             "success": False,
